...
export default function Servidores({ setIsModalOpen }: ServidoresProps) {
                ...
                <div className="flex justify-center items-center gap-4 m-auto max-w-[70%] flex-col md:flex-row">
                    <div className="flex flex-col gap-2 max-w-[55%]">
                        ...
                        <ul className="flex flex-col justify-center gap-2 p-4 list-disc">
                            ...
                            <li><strong>Servidores confiáveis e sem atrasos:</strong> Estabilidade é crucial para uma experiência de jogo perfeita.</li>
                        </ul>
                    ...
                    <div className="fixed inset-0 bg-black/90 flex items-center justify-center list-none">
                        <div className="bg-zinc-900 p-8 rounded-lg flex flex-col md:flex-row items-center justify-center relative">
                            ...
                            <button onClick={fecharModal} className="absolute top-2 right-2 p-2 transition-all duration-300 hover:scale-125 hover:cursor-pointer">
                                <Image src="/ico-fechar.webp" alt="Fechar" objectFit="contain" width={30} height={30} />
                            </button>
                            <Image
                                src="/server-ets.webp"
